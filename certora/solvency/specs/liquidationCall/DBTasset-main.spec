...
/*================================================================================================
  ...
  2. scaledTotalSupplyCVL(_DBT_debt)!=0  - In DBTasset-totSUP0.spec we treat the opposite assumption
  3. ReserveLogic.getNormalizedDebt(...):
     When not inside the function burnBadDebt it always return the same value. (In our spec the value is
     _DBT_dbtIND.)
  4. ReserveLogic.getNormalizedIncome(...):
     When not inside the function burnBadDebt it always return the same value. (In our spec the value is
     _DBT_dbtIND.)
